...
var centerMenu = [
    ...
    ,{
        name: '学习资料收藏',
        url: '../ziliaoCollection/list.html'
    }
    ,{
        name: '学习资料评价',
        url: '../ziliaoCommentback/list.html'
    }
...
// 已废弃,不用了
var adminurl =  "http://localhost:8080/xsxuexiziliaotuijian/admin/dist/index.html#/login";
