...
public class ZiliaoCommentbackView extends ZiliaoCommentbackEntity implements Serializable {
	...
	public ZiliaoCommentbackView() {

	}

	public ZiliaoCommentbackView(ZiliaoCommentbackEntity ziliaoCommentbackEntity) {
		try {
			BeanUtils.copyProperties(this, ziliaoCommentbackEntity);
